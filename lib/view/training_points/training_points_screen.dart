...
class TrainingPointsScreen extends StatefulWidget {
  ...
  const TrainingPointsScreen({Key? key, required this.email}) : super(key: key);
                        ...
                        children: [
                          ...
                          Selector<TrainingPointViewModel, TrainingPointModel?>(
                            ...
                            builder: (context, value, child) => _DescriptionTrainingPoint(
                              ...
                              onScoreChanged: (score) =>
                                  viewModel.updateDocument(key: "monitor1", value: score, msv: msv),
                              scoreT: 3,
                          ...
                          Selector<TrainingPointViewModel, TrainingPointModel?>(
                            ...
                            builder: (context, value, child) => _DescriptionTrainingPoint(
                              ...
                              onScoreChanged: (score) =>
                                  viewModel.updateDocument(key: "monitor2", value: score, msv: msv),
                              scoreT: 2,
                          ...
                          Selector<TrainingPointViewModel, TrainingPointModel?>(
                            ...
                            builder: (context, value, child) => _DescriptionTrainingPoint(
                              ...
                              onScoreChanged: (score) =>
                                  viewModel.updateDocument(key: "monitor3", value: score, msv: msv),
                              scoreT: 3,
                          ...
                          Selector<TrainingPointViewModel, TrainingPointModel?>(
                            ...
                            builder: (context, value, child) => _DescriptionTrainingPoint(
                              ...
                              onScoreChanged: (score) =>
                                  viewModel.updateDocument(key: "monitor4", value: score, msv: msv),
                              scoreT: 2,
                          ...
                          Padding(
                            ...
                            child: UIOutlineButton(
                              title: 'Nộp điểm',
                              onPressed: () {
                                viewModel.updateDocument(key: "history", value: true, msv: msv);
                              },
                            ),
                          )
                        ],
...
class _DescriptionTrainingPoint extends StatelessWidget {
  ...
  void changeScore() {
    ...
    viewModel.getTrainingPoint(msv).then((_) {
      ...
      final sumStudyPoints6 = (trainingPoint?.trainingPoint1 ?? 0) +
          (trainingPoint?.trainingPoint2 ?? 0) +
          (trainingPoint?.trainingPoint3 ?? 0) +
          (trainingPoint?.trainingPoint4 ?? 0) +
          (trainingPoint?.trainingPoint5 ?? 0); // Include study6 score
